...
public class Delivery_Equity extends AppCompatActivity {
    TextView t1, t2, t3;
    EditText et1, et2, et3;
    int brokerage = 0;
    double  stt, exchange, gst, sebi, stamp, res, res1, turnover;

    @SuppressLint("SetTextI18n")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delivery_equity);
        ...
        textviewTitle.setText("Delivery Equity Charges");
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i1, int i2) {
                if (!et1.getText().toString().equals("") && !et2.getText().toString().equals("") && !et3.getText().toString().equals("")) {
                    ...
                    res1 = ((q * r) - (p * r) - res);
                    res1 =Double.parseDouble(new DecimalFormat("##.##").format(res1));
